...
// console.log("num 5: "+num5); //error
console.log("num 6: "+num6); // function 내부 if문 종료 후에도 사용가능
...
function typeTest(){
    ...
    // 객체 내용 출력 방버 2 (객체 전용 for문 for ... in)
    ...
    console.log(user); // 콘솔이 출력 시 보기 더 좋음
